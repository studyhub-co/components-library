...
export interface Material {
  ...
  data: QAData | VectorData | QABaseData | UnitConversionData | null; // TODO list of components interfaces
}

export interface UserReactionResult {
  completed_on: null | string;
  correct_data?: QAData | VectorData | QABaseData | UnitConversionData;
